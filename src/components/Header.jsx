...
const Header = () => {
  ...
  return (
    <header className='max-w-[90%] m-auto'>
        ...
        <h1 className='text-center text-3xl sm:text-6xl lg:text-8xl font-extrabold lg:leading-[120px] text-zinc-900 mt-14 uppercase' data-aos="zoom-in-up" data-aos-duration="800">Full Stack Developer with a passion for web design, UI/UX, and building stunning, user-friendly websites.</h1>
    </header>
  )
}
